...
INSERT INTO JOKE_VERSION (id, joke_id, question, since, until)
VALUES (JOKE_VERSION_SEQ.nextval, 1, 'Co ma wspólnego łyżka z jesienią?', '2020-12-31', null),
       (JOKE_VERSION_SEQ.nextval, 2, 'Co na wojnie nigdy się nie psuje?', '2020-12-31', null),
       (JOKE_VERSION_SEQ.nextval, 3, 'Co fryzjerka ma w lodówce?', '2020-12-31', null),
       (JOKE_VERSION_SEQ.nextval, 4, 'Jak się czuje magik w 2020?', '2020-12-31', null)
;
